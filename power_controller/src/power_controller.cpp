    ...
    , sh_emergency_(SharedVariable<bool>("emergency"))
{
    ...
    battery1_state_pub_         = n_.advertise<rose21_platform::battery_state>(name_ + "/battery1/state", 1, true);
    battery2_state_pub_         = n_.advertise<rose21_platform::battery_state>(name_ + "/battery2/state", 1, true);
    battery_combined_state_pub_ = n_.advertise<rose21_platform::battery_state>(name_ + "/battery_combined/state", 1, true);
...
rose21_platform::battery_state PowerController::getBatteryState(int battery_number)
{
    int index                       = battery_number - 1;
    rose21_platform::battery_state battery_state;
...
rose21_platform::battery_state PowerController::getCombinedBatteryState()
{
    rose21_platform::battery_state battery_combined_state;
    rose21_platform::battery_state bat1 = getBatteryState(1);
    rose21_platform::battery_state bat2 = getBatteryState(2);
