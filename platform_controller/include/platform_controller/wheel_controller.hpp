...
// Commands [string]
// Getters
#define WHEEL_CONTROL_GET_VELOCITY              "200"
#define WHEEL_CONTROL_GET_POSITION              "201"
#define WHEEL_CONTROL_GET_CURRENT               "202"
#define WHEEL_CONTROL_GET_MAX_CURRENT           "203"
#define WHEEL_CONTROL_GET_POS_ERROR             "204"
#define WHEEL_CONTROL_GET_VEL_ERROR             "205"
#define WHEEL_CONTROL_GET_PIDOUT                "206"
#define WHEEL_CONTROL_GET_POUT                  "207"
#define WHEEL_CONTROL_GET_IOUT                  "208"
#define WHEEL_CONTROL_GET_DOUT                  "209"
#define WHEEL_CONTROL_GET_MAE_OUT               "210"
#define WHEEL_CONTROL_GET_FE_OUT                "211"
#define WHEEL_CONTROL_GET_ALARM_STATE           "212"
#define WHEEL_CONTROL_GET_ALL_DRIVE_ENC_DIFF    "213"
#define WHEEL_CONTROL_GET_COMPLETE_STATUS       "214"
#define WHEEL_CONTROL_GET_DEBUG_STATUS          "215"

// Setters
#define WHEEL_CONTROL_DRIVE_PID_VALS            "300"
#define WHEEL_CONTROL_STEER_PID_VALS            "301"
#define WHEEL_CONTROL_START_STOP_VALS           "302"
#define WHEEL_CONTROL_ERROR_TIMERS              "303"

// Actions
#define WHEEL_CONTROL_ENABLE                    "400"
#define WHEEL_CONTROL_MOVE                      "401"
#define WHEEL_CONTROL_BRAKE_MODE                "402"
#define WHEEL_CONTROL_RESET_COMM                "403"           
#define WHEEL_CONTROL_RESET_ALARM               "404"            
#define WHEEL_CONTROL_RESET_PLATFORM            "405"
    
// PID values   
#define WHEEL_CONTROLLER_DRIVE_KI               2000            // Division factor, but zero turns off!
#define WHEEL_CONTROLLER_DRIVE_K                2000        //18000   // Division factor, but zero turns off!
#define WHEEL_CONTROLLER_DRIVE_KD               -1000            // Division factor, but zero turns off!
#define WHEEL_CONTROLLER_DRIVE_KP               0               // Velocity error to acceleration error factor
#define WHEEL_CONTROLLER_DRIVE_ILIMIT           5000000
#define WHEEL_CONTROLLER_DRIVE_SCALE            1000
#define WHEEL_CONTROLLER_DRIVE_FEMAX            8
#define WHEEL_CONTROLLER_DRIVE_MAX_CURR         5000
    
#define WHEEL_CONTROLLER_STEER_KI               1000000         // Division factor, but zero turns off!
#define WHEEL_CONTROLLER_STEER_K                400             // Division factor, but zero turns off!
#define WHEEL_CONTROLLER_STEER_KD               0               // NOT IMPLEMENTED FOR STEER MOTORS
#define WHEEL_CONTROLLER_STEER_KP               0               // NOT USED
#define WHEEL_CONTROLLER_STEER_ILIMIT           10000000
#define WHEEL_CONTROLLER_STEER_SCALE            100       
#define WHEEL_CONTROLLER_STEER_FEMAX            6000
#define WHEEL_CONTROLLER_STEER_MAX_CURR         6000

// Error timers in ms
#define WHEEL_CONTROLLER_FOLLOWING_ERR_TIMER    2000
#define WHEEL_CONTROLLER_CURRENT_ERR_TIMER      100
#define WHEEL_CONTROLLER_CONNECTION_ERR_TIMER   400
#define WHEEL_CONTROLLER_MAE_ERR_TIMER          75

// Generic platform defines
#define WHEEL_CONTROLLER_CLK_FREQ               80000000.0      // [Hz] -> 80Mhz
#define WHEEL_CONTROL_FIRMWARE_ID               1
#define WHEEL_CONTROL_FIRMWARE_MAJOR_VERSION    2
#define WHEEL_CONTROL_FIRMWARE_MINOR_VERSION    4
